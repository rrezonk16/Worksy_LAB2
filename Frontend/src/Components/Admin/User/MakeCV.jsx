...
const MakeCV = () => {
  ...
  const generateHTMLCV = () => {
    ...
    return `
      <div style="width: 210mm; min-height: 295mm; padding: 20mm; font-family: Arial, sans-serif; background: #f4f4f4;">
        <!-- Header Section -->
...
<img src="${userData.user.details.profile_image}" alt="Profile" style="height: 100px; width: 100px; border-radius: 50%; object-fit: cover;"/>
          </div>
        </div>
  ...
  return (
    <div>
      ...
      <div dangerouslySetInnerHTML={{ __html: generateHTMLCV() }} />
      <Footer />
    </div>
  )
}
